...
<main>
  ...
  <div class="output-panel" id="output-panel">
    ...
    <div class="mode3-container" id="mode3-container" style="display:none">
      ...
      <!-- Section 9: Municipal Recommendations & Visitor Warnings (The Feedback Sandwich) -->
      <div class="paper-section-card" id="recommendations-card">
        <div class="paper-header-bar header-burgundy" style="background: linear-gradient(135deg, #8b0000 0%, #4a0000 100%);">
          <span>🥪 MUNICIPAL RECOMMENDATIONS & VISITOR WARNINGS</span>
          <span style="font-size:0.75rem; opacity:0.8;" id="rec-persona-tag">FEEDBACK SANDWICH</span>
        </div>
        <div class="paper-body">
          <div style="font-family: 'Outfit', sans-serif; font-size: 0.95rem; color: #FFD700; font-weight: bold; text-transform: uppercase;" id="rec-persona-name"></div>
          
          <div style="background: #1a120b; border-left: 3px solid #4ca1af; padding: 0.8rem; border-radius: 4px; margin-top: 0.4rem;">
            <div style="font-family: 'Outfit', sans-serif; font-size: 0.75rem; color: #4ca1af; font-weight: bold; text-transform: uppercase;" id="rec-layer1-title">🍞 1. The Nominal Praise:</div>
            <div style="font-family: 'EB Garamond', serif; font-size: 1.15rem; color: #ffffff; margin-top: 0.2rem;" id="rec-layer1-text"></div>
          </div>

          <div style="background: #250a0a; border-left: 3px solid #e62e3d; padding: 0.8rem; border-radius: 4px; margin-top: 0.4rem;">
            <div style="font-family: 'Outfit', sans-serif; font-size: 0.75rem; color: #ff8080; font-weight: bold; text-transform: uppercase;" id="rec-layer2-title">🥩 2. The Acidic Reality:</div>
            <div style="font-family: 'EB Garamond', serif; font-size: 1.15rem; color: #ffe6e6; margin-top: 0.2rem; font-style: italic;" id="rec-layer2-text"></div>
          </div>

          <div style="background: #1c1409; border-left: 3px solid #FFD700; padding: 0.8rem; border-radius: 4px; margin-top: 0.4rem;">
            <div style="font-family: 'Outfit', sans-serif; font-size: 0.75rem; color: #FFD700; font-weight: bold; text-transform: uppercase;">📜 3. Mandatory Municipal Recommendation:</div>
            <div style="font-family: 'EB Garamond', serif; font-size: 1.15rem; color: #e8d5a3; margin-top: 0.2rem; font-weight: bold;" id="rec-layer3-text"></div>
          </div>
        </div>
      </div>
...
<script>
  ...
  const HYPER_LOCAL_DATABASE = {
    bracknell: {
      paper: 'Bracknell Standard & Lexicon News',
      spotted: 'Spotted: Bracknell Lexicon & Swinley Forest',
      gazette_headline: 'CORAL REEF WATERWORLD PIRATE SHIP FLUME DELAYED AFTER SWIMMING WRISTBAND TIMER AUDIT',
      spotted_chatter: 'To whoever spent 45 minutes searching for their Ford Focus in Yellow Zone Level 3 of The Lexicon car park: security have your ticket.',
      local_scandal: 'The great 2017 Lexicon car park ticket machine confusion and Swinley Forest mountain bike trail right-of-way disputes.',
      tourist_slogan: 'Bracknell: Berkshire New Town Ambition, The Lexicon & Coral Reef Waterworld!',
      tourist_brochure: 'Welcome to Bracknell! Experience Berkshire New Town transformation! Featuring The Lexicon retail plaza, Coral Reef Waterworld pirate flumes, South Hill Park arts manor, and sprawling Bracknell Forest trails!',
      tripadvisor_audit: 'ANALYST EXPERT AUDIT #1949: Bracknell presents a fascinating study in New Town regeneration, where The Lexicon shopping plaza meets Swinley Forest mountain bike trails. Rating: 4.1/5 — Excellent retail and waterpark facilities.'
    },
  ...
  // 3 DECOUPLED COMBINATORIAL GENERATION ENGINES (CD3 ARCHITECTURE)
  const BROCHURE_SYNTHESIZER = {
    ...
    coastal: {
      slot1: ['Welcome to coastal {town}', 'Perched above the Channel waves in {town}', 'Steeped in 19th-century pier variety show tradition in {town}', 'Discover the maritime charm of {town}'],
      slot2: ['where 1920s land plot raffles meet salt-corroded undercliff walks and', 'famed for fresh Cromer crabs and end-of-pier comedy shows where', 'where 40 beached upright pianos serenaded Channel tides and', 'home to historic RNLI lifeboat slipways where'],
      slot3: ['holidaymakers enjoy lukewarm fish & chips while', 'feral seagulls swoop from theatre roofs and', 'walk the historic Greenwich Meridian line alongside', 'inspect salt-crusted beach hut padlocks in'],
      slot4: ['invigorating 60mph coastal sea-gales!', 'dramatic chalk reef panoramas!', 'authentic Victorian seaside nostalgia!', 'scenic coastal Undercliff walks!']
    },
    east_anglia: {
      slot1: ['Step into historic {town}', 'Heart of East Anglia in {town}', 'Steeped in 1381 Peasants Revolt history in {town}', 'Welcome to ancient {town}'],
      slot2: ['where Horatio Nelson carved schoolboy initials at Paston Grammar School and', 'famed for 14th-century market charters and sugar beet harvests where', 'where 18th-century weaver loom strikes meet duck decoy whistles and', 'home to Jacobean Blickling Estate gardens where'],
      slot3: ['visitors sample fresh coastal crabs and', 'parish elders audit sugar beet harvester parking while', 'explore parish church spire ruins and', 'inspect weekly farmers market stalls alongside'],
      slot4: ['authentic East Anglian market charm!', 'historic timber-framed coaching inns!', 'peaceful Bure Valley narrow gauge steam train rides!', 'picturesque fenland landscapes!']
    },
    northern_mill: {
      slot1: ['Welcome to industrial {town}', 'High in the Pennine valleys of {town}', 'Steeped in 19th-century textile mill heritage in {town}', 'Discover the rugged beauty of {town}'],
      slot2: ['where soaring stone chimney stacks overlook cobbled canal towpaths and', 'famed for Yorkshire pudding baking battles and', 'where Victorian ironworks meet limestone quarry trails and', 'home to historic steam loom mills where'],
      slot3: ['walkers enjoy hearty meat & potato pies while', 'local weavers discuss Pennine trail routes and', 'inspect restored steam engine looms alongside', 'sample craft ales in rustic granite taverns in'],
      slot4: ['dramatic Yorkshire gritstone scenery!', 'authentic Northern industrial pride!', 'panoramic Pennine valley vistas!', 'warm pub hearth hospitality!']
    },
    industrial_commuter: {
      slot1: ['Welcome to {town}', 'Experience Berkshire New Town ambition in {town}', 'Hailed by post-war planners as a triumph of modern engineering in {town}', 'Discover post-war civic ambition in {town}'],
      slot2: ['where glass-canopied retail plazas meet 4-tier orbital ring roads and', 'famed for 1970s precinct architecture and seamless rail links where', 'where Coral Reef Waterworld pirate flumes meet Swinley Forest trails and', 'home to M4 commuter belt convenience where'],
      slot3: ['visitors explore modern shopping plazas while', 'commuters catch fast trains to London Paddington and', 'enjoy family leisure pools alongside', 'inspect post-war civic precinct heritage in'],
      slot4: ['vibrant suburban retail centers!', 'modern Berkshire New Town convenience!', 'sprawling pine forest walking trails!', 'unmatched transport connections!']
    },
    market_parish: {
      slot1: ['Welcome to historic {town}', 'Granted its royal market charter in 1294, {town}', 'Steeped in 13th-century market square tradition in {town}', 'Discover the heritage of {town}'],
      slot2: ['where ancient timber-framed coaching inns meet cobblestone market squares and', 'famed for weekly farmers markets and parish weighing scales where', 'where medieval charter fairs meet artisan bakeries and', 'home to historic parish green traditions where'],
      slot3: ['visitors sample artisanal sourdough loaves while', 'parish councillors discuss market stall licenses and', 'inspect 14th-century charter documents alongside', 'enjoy traditional pub hearth banter in'],
      slot4: ['sublimely preserved charter market squares!', 'authentic historic market town charm!', 'picturesque parish green surroundings!', 'warm coaching inn hospitality!']
    }
  };

  const AUDIT_SYNTHESIZER = {
    coastal: {
      headline: 'ANALYST EXPERT AUDIT #4092: 1916 Land Raffles & Greenwich Meridian Erosion in {town}',
      audit: 'ANALYST EXPERT AUDIT #4092: {town} presents a fascinating study in coastal resignation. Founded as a 1916 newspaper raffle scheme, the town consists of a single linear road network blanketed by a 72-hour sea-fog. Rating: 1.2/5 — Bring a foghorn and your own wellies.'
    },
    east_anglia: {
      headline: 'ANALYST EXPERT AUDIT #1381: Peasants Revolt Memorials & Sugar Beet Logistics in {town}',
      audit: 'ANALYST EXPERT AUDIT #1381: {town} is a remarkably preserved East Anglian market center where 14th-century rebel history meets 1978 Ferguson tractor logistics. Rating: 4.4/5 — Outstanding parish tea rooms.'
    },
    industrial_commuter: {
      headline: 'ANALYST EXPERT AUDIT #1974: Post-War Precinct Architecture & Ring Road Navigation in {town}',
      audit: 'ANALYST EXPERT AUDIT #1974: {town} offers a masterclass in post-war civic planning. The modern retail plaza effectively masks a complex 4-tier orbital roundabout network. Rating: 3.8/5 — Efficient retail and fast rail links.'
    },
    agricultural: {
      headline: 'ANALYST EXPERT AUDIT #1724: 300-Year Cider Orchards & Slope Navigation in {town}',
      audit: 'ANALYST EXPERT AUDIT #1724: {town} is an authentic West Country parish where Double Gloucester cheese rolling meets autumn marrow audits. Rating: 4.3/5 — High agrarian charm.'
    },
    cathedral_heritage: {
      headline: 'ANALYST EXPERT AUDIT #1209: University Quadrangles & River Punting Disputes in {town}',
      audit: 'ANALYST EXPERT AUDIT #1209: {town} features 800 years of academic grandeur and cobbled alleyway heritage, occasionally interrupted by punting collisions. Rating: 4.6/5 — Exceptional scholarly atmosphere.'
    },
    celtic: {
      headline: 'ANALYST EXPERT AUDIT #1603: Highland Tartan Weaving & Single-Malt Casks in {town}',
      audit: 'ANALYST EXPERT AUDIT #1603: {town} delivers breathtaking highland scenery, peat-fired pub hearths, and centuries of tartan weaving tradition. Rating: 4.7/5 — Prime highland site.'
    },
    northern_mill: {
      headline: 'ANALYST EXPERT AUDIT #1842: Pennine Gritstone Architecture & Canal Towpaths in {town}',
      audit: 'ANALYST EXPERT AUDIT #1842: {town} showcases rugged Northern industrial heritage with restored steam engine looms and sturdy stone taverns. Rating: 4.2/5 — Robust gritstone character.'
    },
    market_parish: {
      headline: 'ANALYST EXPERT AUDIT #1294: Royal Market Charters & Timber Coaching Inns in {town}',
      audit: 'ANALYST EXPERT AUDIT #1294: {town} is a wonderfully preserved historic market square town with 13th-century charter heritage and artisanal baking. Rating: 4.4/5 — Excellent market square.'
    }
  };

  const REVIEW_SYNTHESIZER = {
    industrial_commuter: [
      { reviewer: "M4Commuter", rating: 3, text: "Commuted through {town} main station. Fast train to London Paddington, but the multi-storey car park machine only accepted 20p coins." },
      { reviewer: "RetailShopper", rating: 4, text: "Visited {town} for weekend retail shopping. Good selection of stores, though I got turned around twice on the dual carriageway ring road." },
      { reviewer: "SuburbanFamily", rating: 4, text: "Took the kids to the local leisure pool in {town}. Kids loved the water flumes; dad spent 20 minutes finding a parking space." }
    ],
    east_anglia: [
      ...
      { reviewer: "PastonScholar", rating: 4, text: "Inspected Paston Grammar School in {town}. Saw Horatio Nelsons carved initials and a 1978 Ferguson tractor parked outside the tea shop." },
      { reviewer: "MarketStroller", rating: 4, text: "Bought fresh Norfolk strawberries at the {town} weekly market. Friendly stallholders and lovely parish church spire view." }
    ],
    coastal: [
      { reviewer: "MeridianWalker", rating: 2, text: "Walked the Meridian Line in {town}. Got disoriented by sea-fog and ended up on the clifftop gravel patch thinking I was in Normandy." },
      { reviewer: "CrabFisher", rating: 4, text: "Crabbing off the pier in {town}. Caught 3 decent crabs, but a seagull stole my sausage roll." },
      { reviewer: "BeachHutOwner", rating: 3, text: "Love the sea air in {town}, but salt gale corrosion requires repainting the beach hut door every 6 weeks." }
    ],
    agricultural: [
      { reviewer: "CiderTaster", rating: 4, text: "Tried authentic farmhouse cider in {town}. Woke up 14 hours later in a hayloft with a ribbon for 2nd place in the parish marrow contest." },
      { reviewer: "CheeseRunner", rating: 3, text: "Participated in the annual slope race near {town}. Lost a boot halfway down but got a slice of Double Gloucester." },
      { reviewer: "CotswoldWalker", rating: 5, text: "Beautiful thatch cottages and pub hearths in {town}. Perfect autumn countryside walk." }
    ],
    cathedral_heritage: [
      { reviewer: "QuadStroller", rating: 4, text: "Visited the university quadrangles in {town}. Got yelled at in Latin by a college porter for stepping on the grass, 10/10 authenticity." },
      { reviewer: "PuntingEnthusiast", rating: 4, text: "Rented a wooden punt in {town}. Slightly chaotic river traffic near the bridge, but wonderful historic views." },
      { reviewer: "BookwormVisitor", rating: 5, text: "Explored ancient antiquarian bookshops in {town}. Found a 19th-century map of the parish." }
    ],
    celtic: [
      { reviewer: "HighlandHiker", rating: 5, text: "Hiked the glen trails near {town}. Breathtaking mountain views and warm peat fire at the pub afterwards." },
      { reviewer: "TartanCollector", rating: 4, text: "Visited the traditional mill in {town}. Bought a genuine wool plaid scarf." },
      { reviewer: "DistilleryTourer", rating: 5, text: "Sampled single-malt cask reserves in {town}. Outstanding highland hospitality." }
    ],
    northern_mill: [
      { reviewer: "TowpathWalker", rating: 4, text: "Walked the canal towpath in {town}. Impressive Victorian mill chimneys and solid Yorkshire hospitality." },
      { reviewer: "GritstoneClimber", rating: 4, text: "Explored the Pennine trails near {town}. Stopped for a hearty meat & potato pie in the village tavern." },
      { reviewer: "HeritageRailFan", rating: 5, text: "Rode the steam loom shuttle line in {town}. Great historical preservation." }
    ],
    market_parish: [
      { reviewer: "ArtisanBaker", rating: 5, text: "Visited the Saturday market in {town}. Bought an sourdough loaf and fresh honey from a local farm." },
      { reviewer: "CharterHistorian", rating: 4, text: "Inspected the 13th-century charter plaque in {town}. Fascinating timber coaching inn square." },
      { reviewer: "PubHearthGuest", rating: 4, text: "Stayed overnight at a historic coaching inn in {town}. Cosy open fire and great local ale." }
    ]
  };


  // 4TH ENGINE: MUNICIPAL RECOMMENDATIONS & VISITOR WARNINGS (THE FEEDBACK SANDWICH)
  const RECOMMENDATIONS_SYNTHESIZER = {
    // Hyper-Local Overrides
    cromer: {
      ayoade: {
        persona: 'RICHARD AYOADE (TRAVEL MAN AUDIT)',
        layer1_title: '🍞 1. The Nominal Praise:',
        layer1: 'To give credit where credit is due, the fresh Cromer crabs are genuinely world-class crustacean dining...',
        layer2_title: '🥩 2. The Acidic Reality:',
        layer2: 'HOWEVER, three centuries of coastal isolation have led the local populace to slowly adopt a sideways-walking gait and crab-like defensive pincers whenever a tourist approaches the RNLI slipway.',
        layer3: 'Do not attempt eye contact with anyone holding a wooden crabbing bucket after 4:00pm, and under no circumstances mention Sheringham.'
      },
      mitchell: {
        persona: 'DAVID MITCHELL (PEDANTIC OUTRAGE RANT)',
        layer1_title: '🍞 1. The Banal Concession:',
        layer1: 'I will concede that the 19th-century pier is structurally sound for at least another fortnight...',
        layer2_title: '🥩 2. The Explosive Pedantic Outrage:',
        layer2: 'BUT WHY MUST FERAL SEAGULLS ON THE THEATRE ROOF OPERATE WITH THE TACTICAL PRECISION OF AN AIR-FORCE SQUADRON?! A man cannot eat a lukewarm crab roll without conducting a 360-degree radar sweep!',
        layer3: 'Stay in the car with the engine running and eat your fish & chips with the windows rolled up.'
      }
    },
    bracknell: {
      ayoade: {
        persona: 'RICHARD AYOADE (TRAVEL MAN AUDIT)',
        layer1_title: '🍞 1. The Nominal Praise:',
        layer1: 'The Lexicon retail plaza presents a pleasantly canopy-covered shopping promenade...',
        layer2_title: '🥩 2. The Acidic Reality:',
        layer2: 'HOWEVER, the multi-storey car park is a spatial labyrinth engineered to trap Ford Focus drivers in Yellow Zone Level 3 until the end of time.',
        layer3: 'Pay for your parking ticket BEFORE stepping into the lift unless you enjoy 40-minute stairwell reconciliations.'
      },
      mitchell: {
        persona: 'DAVID MITCHELL (PEDANTIC OUTRAGE RANT)',
        layer1_title: '🍞 1. The Banal Concession:',
        layer1: 'I will admit that Coral Reef Waterworld has acceptable pirate ship flumes for children...',
        layer2_title: '🥩 2. The Explosive Pedantic Outrage:',
        layer2: 'BUT WHY DOES THE TICKET MACHINE ONLY ACCEPT EXACT CHANGE IN 20p COINS?! We have landed rovers on Mars, yet Berkshire municipal car parks demand 1978 coinage!',
        layer3: 'Carry £14 in exact 20p coins in a heavy canvas sack at all times.'
      }
    },
    slough: {
      ayoade: {
        persona: 'RICHARD AYOADE (TRAVEL MAN AUDIT)',
        layer1_title: '🍞 1. The Nominal Praise:',
        layer1: 'The main trading estate is marvelously efficient at housing mid-level freight logistics...',
        layer2_title: '🥩 2. The Acidic Reality:',
        layer2: 'HOWEVER, John Betjemans poetic wish remains unfilled, as the parish concourse has simply been replaced by 3 vape shops and a disused Wimpy sign.',
        layer3: 'Keep moving toward the M4 slip road and do not stop for directions.'
      },
      mitchell: {
        persona: 'DAVID MITCHELL (PEDANTIC OUTRAGE RANT)',
        layer1_title: '🍞 1. The Banal Concession:',
        layer1: 'The rail connection to London Paddington is undeniably brisk...',
        layer2_title: '🥩 2. The Explosive Pedantic Outrage:',
        layer2: 'BUT WHY MUST THE PARISH COUNCIL COVERS-UP EVERY SINGLE HISTORIC COBBLESTONE WITH PRE-CAST 1974 CONCRETE BOLLARDS?! It is an aesthetic catastrophe!',
        layer3: 'Remain inside the train carriage until Reading.'
      }
    },

    // Regional Archetype Fallbacks
    coastal: {
      ayoade: {
        persona: 'RICHARD AYOADE (TRAVEL MAN AUDIT)',
        layer1_title: '🍞 1. The Nominal Praise:',
        layer1: 'The coastal sea air in {town} is undeniably crisp and rich in ozone...',
        layer2_title: '🥩 2. The Acidic Reality:',
        layer2: 'HOWEVER, the 60mph horizontal sea-gales are specifically calibrated to deposit salt-spray onto your spectacles within 4 seconds of exiting the car.',
        layer3: 'Always face away from the Channel when unspooling alukewarm sausage roll.'
      },
      mitchell: {
        persona: 'DAVID MITCHELL (PEDANTIC OUTRAGE RANT)',
        layer1_title: '🍞 1. The Banal Concession:',
        layer1: 'The local fish & chip shop serves a passable piece of haddock...',
        layer2_title: '🥩 2. The Explosive Pedantic Outrage:',
        layer2: 'BUT WHY DOES THE SEA-FOG SETTLE EXACTLY AT 3:00PM EVERY SINGLE DAY?! It is as if the weather gods decided {town} had seen enough daylight for one century!',
        layer3: 'Equip your raincoat with high-visibility reflective tape and bring a foghorn.'
      }
    },
    east_anglia: {
      ayoade: {
        persona: 'RICHARD AYOADE (TRAVEL MAN AUDIT)',
        layer1_title: '🍞 1. The Nominal Praise:',
        layer1: 'The 14th-century parish church ruins in {town} provide a picturesque backdrop...',
        layer2_title: '🥩 2. The Acidic Reality:',
        layer2: 'HOWEVER, local traffic is perpetually throttled by 1978 Ferguson tractors towing sugar beet harvesters at 4 miles per hour.',
        layer3: 'Allow 45 extra minutes if travelling behind a sugar beet truck.'
      },
      mitchell: {
        persona: 'DAVID MITCHELL (PEDANTIC OUTRAGE RANT)',
        layer1_title: '🍞 1. The Banal Concession:',
        layer1: 'The weekly farmers market in {town} sells superb local strawberries...',
        layer2_title: '🥩 2. The Explosive Pedantic Outrage:',
        layer2: 'BUT WHY ARE THERE 4 SEPARATE PARISH COUNCILLORS ARGUING OVER FLOWER TUB PERMITS IN THE BAKERY QUEUE?! Can a man not purchase a bloomer without a sub-committee debate?!',
        layer3: 'Buy your bread quickly and avoid taking sides in petunia color disputes.'
      }
    },
    industrial_commuter: {
      ayoade: {
        persona: 'RICHARD AYOADE (TRAVEL MAN AUDIT)',
        layer1_title: '🍞 1. The Nominal Praise:',
        layer1: 'The glass-canopied retail precinct in {town} offers sheltered shopping convenience...',
        layer2_title: '🥩 2. The Acidic Reality:',
        layer2: 'HOWEVER, navigating the 4-tier dual carriageway ring road requires a degree in top-tier navigation.',
        layer3: 'Take the third exit at the main roundabout regardless of what your sat-nav advises.'
      },
      mitchell: {
        persona: 'DAVID MITCHELL (PEDANTIC OUTRAGE RANT)',
        layer1_title: '🍞 1. The Banal Concession:',
        layer1: 'The multi-storey car park in {town} has ample covered parking spaces...',
        layer2_title: '🥩 2. The Explosive Pedantic Outrage:',
        layer2: 'BUT WHY MUST THE TICKET MACHINE BE POSITIONED AT A 45-DEGREE ANGLE BEHIND A CONCRETE BOLLARD?! It requires gymnastic flexibility just to insert a £2 coin!',
        layer3: 'Keep exact change in your glovebox and prepare for a 10-minute parking meter struggle.'
      }
    }
  };
  ...
  function getRegionalProfile(town) {
    ...
    return {
      ...
      brochures: [
        'Welcome to ' + town + '! Hailed by post-war planners as a triumph of Berkshire civic ambition, featuring sprawling retail plazas, glass-canopied high streets, and seamless rail connections to London Paddington!'
      ],
      reviews: [
        { reviewer: "M4Commuter", rating: 3, text: 'Commuted through ' + town + ' main station. Train was on time, but the multi-storey car park machine only accepted 20p coins.' },
        { reviewer: "RetailShopper", rating: 4, text: 'Visited ' + town + ' for weekend shopping. Great variety of high street stores, though I got turned around twice on the dual carriageway ring road.' },
        { reviewer: "SuburbanFamily", rating: 4, text: 'Took the kids to the local leisure pool in ' + town + '. Kids loved the water flumes; dad spent 20 minutes finding a parking space.' }
      ],
      taHeadlines: [
  ...
  function buildDynamicFallbackResult(town, lensId, mode) {
    ...
    function synthesizeFreshSentence(townName, archKey) {
      const syn = BROCHURE_SYNTHESIZER[archKey] || BROCHURE_SYNTHESIZER.industrial_commuter;
      ...
      return (s1 + ', ' + s2 + ' ' + s3 + ' ' + s4).replace(/{town}/g, townName);
    }

    function synthesizeAudit(townName, archKey) {
      const auditObj = AUDIT_SYNTHESIZER[archKey] || AUDIT_SYNTHESIZER.industrial_commuter;
      return {
        headline: (auditObj.headline || '').replace(/{town}/g, townName),
        audit: (auditObj.audit || '').replace(/{town}/g, townName)
      };
    }

    function synthesizeReviews(townName, archKey) {
      const revPool = REVIEW_SYNTHESIZER[archKey] || REVIEW_SYNTHESIZER.industrial_commuter;
      return revPool.map(r => ({
        reviewer: r.reviewer,
        rating: r.rating,
        text: (r.text || '').replace(/{town}/g, townName)
      }));
    }

    const synthesizedBrochure = synthesizeFreshSentence(town, archetype);
    const synthesizedAudit     = synthesizeAudit(town, archetype);
    const synthesizedReviews   = synthesizeReviews(town, archetype);
    ...
    const taHead   = localLore.tripadvisor_headline || synthesizedAudit.headline;
    const taRev    = localLore.tripadvisor_audit || synthesizedAudit.audit;

    const safeReviewPool = (Array.isArray(synthesizedReviews) && synthesizedReviews.length >= 3) ? synthesizedReviews : reg.reviews;
    const rIdx1_safe = hashTown(town, 401) % safeReviewPool.length;
    const rIdx2_safe = (rIdx1_safe + 1) % safeReviewPool.length;
    const rIdx3_safe = (rIdx1_safe + 2) % safeReviewPool.length;
    const reviews    = [safeReviewPool[rIdx1_safe], safeReviewPool[rIdx2_safe], safeReviewPool[rIdx3_safe]];
  ...
  function renderOutput(location, result, autoScroll = true) {
    ...
    if (isMode3) {
      ...
      // Render Section 9: Municipal Recommendations & Visitor Warnings (The Feedback Sandwich)
      const cleanLoc = location.toLowerCase().trim();
      const recData = RECOMMENDATIONS_SYNTHESIZER[cleanLoc] || RECOMMENDATIONS_SYNTHESIZER[archetype] || RECOMMENDATIONS_SYNTHESIZER.industrial_commuter;
      const clickCount = (typeof window !== 'undefined' && window._clickCount) ? window._clickCount : 0;
      const isAyoade = (hashTown(location, 888) + clickCount) % 2 === 0;
      const recItem  = isAyoade ? (recData.ayoade || recData.mitchell) : (recData.mitchell || recData.ayoade);

      if (recItem) {
        if (document.getElementById('rec-persona-name'))  document.getElementById('rec-persona-name').textContent  = '🎙️ AUDITOR VOICE: ' + (recItem.persona || '');
        if (document.getElementById('rec-layer1-title'))  document.getElementById('rec-layer1-title').textContent  = recItem.layer1_title || '🍞 1. Praise:';
        if (document.getElementById('rec-layer1-text'))   document.getElementById('rec-layer1-text').textContent   = (recItem.layer1 || '').replace(/{town}/g, location);
        if (document.getElementById('rec-layer2-title'))  document.getElementById('rec-layer2-title').textContent  = recItem.layer2_title || '🥩 2. Reality:';
        if (document.getElementById('rec-layer2-text'))   document.getElementById('rec-layer2-text').textContent   = (recItem.layer2 || '').replace(/{town}/g, location);
        if (document.getElementById('rec-layer3-text'))   document.getElementById('rec-layer3-text').textContent   = (recItem.layer3 || '').replace(/{town}/g, location);
      }
